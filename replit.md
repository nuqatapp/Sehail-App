...
app/
  ...
  (tabs)/
    ...
    index.tsx           - المجلس (Home dashboard + interactive tip + streak)
  ...
  prep-gear.tsx         - إحتياجات الرحلة (Prep gear + share readiness)
...
- `categories.firstFiveMinutes.entries[]` - 6 emergency step-by-step cards (scorpion, snake, heatstroke, jellyfish, drowning, lost)

## Key Features
1. Home dashboard with interactive daily tips + ad banner
2. Learning streak (Duolingo-style) with 7-day indicators, persisted in AsyncStorage
3. Smart checklists with offline persistence (land + sea) + share readiness on completion
4. "First 5 Minutes" emergency step cards - numbered steps with call button
5. "Quick ID" - fast creature/hazard identification grid
6. Field guide (creatures, plants, hazards) with env badges
7. Navigation guide (stars, compass, land reading, marine nav, digital tools, orientation recovery)
8. Stories and tactics (18 entries across land/sea/shared)
